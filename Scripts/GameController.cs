...
public class GameController : MonoBehaviour
{
    ...
    // Sets player death to true
    public void playerDeath()
    {
        inputStatusDictionary[ControlType.Die].status = true;
    }

    public void playerFall()
    {
        inputStatusDictionary[ControlType.Jump].status = true;
    }
